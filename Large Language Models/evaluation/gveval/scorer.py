...
class Scorer:
    def __init__(self):
        load_dotenv()
        self.openai_api_key = os.getenv("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")
